var texts = [
  ...
  // message 2
  "We said love to each other on October 25, 2023, and we became lovers. And then we spent a sweet week together. Sweetheart, I want to be with you from now to the end.^^I miss you!^^Happy Valentine's Day!",
  // message 3
